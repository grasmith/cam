...
'--- update settings
call pLog("SOLE2J PROGRAM v0305")
%wkfile = "SOLE2J"
t_Settings(5,2) = t_Settings(3,2)
t_Settings(6,2) = t_Settings(4,2)
t_Settings(3,2) = "E2J"
t_Settings(4,2) = "Employment Stimulus within the Eurozone JM1"
...
call Floor("SP_EUW","dlog(VV_EUW)", "0.05",0,20)
call Link("G_EUW","SP_EUW",1)
call Floor("G_UK","(NE_UK/NWP_UK)", "0.77",0,10)
call Link("IP_UK","G_UK",1)
