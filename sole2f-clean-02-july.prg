...
'--- Reflation from reduced private saving in West Europe
SP_EUW_ins=-0.015

'--- Increased government expenditure and revenues
G_EUW_ins=0.03
G_EUW_ins.fill(s) 0.01,0.01,0.01,0.01,0.01,0.02,0.02,0.03,0.03,0.03,0.03
YG_EUW_ins=0.01

' UK Exchange rate devaluation
call Target("rxu_UK", "rx_UK/rx_US", "0.85", 1, 10)

' Targets for private investment
call Floor("IP_UK", "IP_UK/VV_UK", "0.16", 0, 30)
call Floor("IP_EUW", "IP_EUW/VV_EUW", "0.18", 0, 30)
call Floor("IP_EUS", "IP_EUS/VV_EUS", "0.18", 0, 30)
call Floor("IP_EUN", "IP_EUN/VV_EUN", "0.18", 0, 30)
call Ceiling("IP_EUE", "IP_EUE/VV_EUE", "0.18", 0, 30)

' Targets for government spending
call Ceiling("G_UK", "G_UK/VV_UK", "0.25", 0, 10)
'call Floor("G_EUW", "G_EUW/VV_EUW", "0.245", 0, 1)
call Ceiling("G_EUS", "G_EUS/VV_EUS", "0.25", 0, 10)
call Ceiling("G_EUN", "G_EUN/VV_EUN", "0.31", 0, 10)
...
call mk_soas_graphs("e1b; soas baseline: e2f; soas expansion in ez")
call pEnd
