...
call Floor("G_EUW","(NE_EUW/NWP_EUW)", "0.67 0.675 0.68 0.685 0.69 0.695 0.70 0.705 *0.71",0,40)
call Link("IP_EUW","G_EUW",0.5)
'IP_EUW_ins=0.01
...
call Target("YG_EUN","YG_EUN/VV_EUN", ".29 .30 *.31", 0, 20)
call Target("YG_EUE","YG_EUE/VV_EUE", ".18 .19 *.20", 0, 10)
...
call mk_soas_graphs("e1b; austerity: e2d; expansion")
call pEnd
