...
' CAM version 4.6
'
' Global regionalisation with multi-speed Europe
'
' The program reads SOLE2.wf1 and creates SOLE4.wf1
'
...
'
' Europe
'  exchange rates are adjusted to support growth objectives
...
'
' N America and E Asia: similar loose regional groupings
' S America and S Asia: weak regional cooperation
'==================================================================
' OPTIONS
'==================================================================
include "set"
...
%wkfile = "SOLE4"
t_Settings(3,2) = "E4"
t_Settings(4,2) = "Regionalisation with multi-speed Europe"
...
'--- growth-orientated real exchange rate policies
...
rxu_EUS_ins = 0
rxu_UK_ins = 0
call Floor("rxu_EUE", "@pc(V_EUE)", "4", -20, 15)
call Floor("rxu_EUN", "@pc(V_EUN)", "2", -20, 15)
call Floor("rxu_EUS", "@pc(V_EUS)", "3.5", -20, 15)
call Floor("rxu_UK", "@pc(V_UK)", "2", -20, 15)
...
call Floor("G_UK", "NE_UK/(NWP_UK+NOP_UK)", "0.60", 0.1, 10)
call Floor("G_EUS", "NE_EUS/(NWP_EUS+NOP_EUS)", "0.54", 0.1, 10)
...
'--- drop investment and trade collapse in Europe
for %b EUN EUW UK EUS EUE
  IP_{%b}_ins = 0
  IV_{%b}_ins = 0
  MM$_{%b}_ins = 0
...
'--- investment stimulus in S and E Europe
IP_EUS_ins = 0.01
