...
call Floor("G_EUN","(NE_EUN/NWP_EUN)", "0.71 0.72 0.73 0.74 0.75 0.76 0.77 *0.78",0,30)
'call Link("IP_EUN","G_EUN",1)
IP_EUN_ins=0.01
call Floor("G_EUE","(NE_EUE/NWP_EUE)", "0.58 0.59 0.60 0.61 0.62 *0.63",0,20)
IP_EUE_ins=0.02
...
call Target("YG_EUN","YG_EUN/VV_EUN", ".29 .30 .31 *.32", 0, 30)
...
'call Target("rxu_UK","rx_UK","0.95 0.9 0.85 *0.8", 0, 20)
'call Target("rxu_EUW","rx_EUW","1.09 1.08 1.07 *1.06", 0, 20)
'call Target("rxu_EUN","rx_EUN","1.3 1.25 *1.2", 0, 20)
